...
const ServiceProcess: FC<ServiceProcessProps> = ({ title, steps }) => {
  return (
    // REDUCED: Vertical padding from py-20/32 to py-12/20
    <section className="relative font-nunito bg-slate-50 py-12 md:py-20 overflow-hidden">
      ...
      <div className="container relative mx-auto px-4 md:px-8">
        {/* Section Title */}
        {/* REDUCED: Bottom margin from mb-20/32 to mb-12/20 */}
        <div className="mb-12 md:mb-20 text-center max-w-4xl mx-auto">
          ...
          {/* Accent bar to Ocean Blue */}
          <div className="h-1.5 w-24 bg-[#1677B3] mx-auto rounded-full" />
        </div>

        {/* Timeline Container */}
        {/* REDUCED: Max width from 6xl to 5xl for a tighter column */}
        <div className="relative mx-auto max-w-5xl">
          ...
          {/* REDUCED: Gap between items from gap-16/32 to gap-10/20 */}
            ...
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* REDUCED: Top position from top-8 to top-6 to match new padding */}
                  <div className="absolute left-8 top-0 md:left-1/2 md:top-6 md:-translate-x-1/2 z-10">
                    {/* Ring color to Ocean Blue */}
                    <div className="flex h-4 w-4 -translate-x-[7px] items-center justify-center rounded-full bg-white ring-4 ring-[#1677B3] md:h-5 md:w-5 md:translate-x-0 md:ring-[5px] shadow-lg"></div>
                  </div>

                  {/* MAIN CARD SIDE */}
                  {/* REDUCED: Width from 45% to 42% to bring cards slightly closer to center */}
                  <div className={`pl-16 md:pl-0 w-full md:w-[42%]`}>
                    <div
                      // REDUCED: Padding inside card from p-8/10 to p-6/8
