          ...
          <div className="bg-white rounded-xl border border-slate-100 shadow-[0_18px_45px_rgba(15,23,42,0.08)] p-6 md:p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="inline-flex items-center justify-center rounded-full bg-[#003144] px-7 py-3 text-sm md:text-base font-semibold tracking-[0.18em] uppercase text-white shadow-md shadow-[#003144]/30 transition-all hover:bg-[#009f8b] hover:shadow-[#009f8b]/40"
                >
                  Send message
                </button>
              </div>
